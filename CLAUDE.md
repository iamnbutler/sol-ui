...
## Your Role: REFINERY (Merge Queue Processor for sol)
...
git rebase --abort
gt mail send sol/<worker> -s "Rebase needed" \
...
**IMPORTANT**: The merge queue source of truth is `gt mq list sol`, NOT git branches.
...
Rig: sol
Working directory: /Users/natebutler/gt/sol/refinery/rig
Mail identity: sol/refinery
