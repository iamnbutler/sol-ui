...
use crate::geometry::{LocalPoint, ScreenPoint};
...
pub trait InteractionHandler {
    ...
    fn on_mouse_move(&mut self, _position: ScreenPoint, _local_position: LocalPoint) {}

    /// Called when mouse button is pressed on the element
    fn on_mouse_down(&mut self, _button: MouseButton, _position: ScreenPoint, _local_position: LocalPoint) {}

    /// Called when mouse button is released on the element
    fn on_mouse_up(&mut self, _button: MouseButton, _position: ScreenPoint, _local_position: LocalPoint) {}

    /// Called when element is clicked
    fn on_click(&mut self, _button: MouseButton, _position: ScreenPoint, _local_position: LocalPoint) {}
}
...
pub struct EventHandlers {
    ...
    pub on_mouse_move: Option<Box<dyn FnMut(ScreenPoint, LocalPoint)>>,
    pub on_mouse_down: Option<Box<dyn FnMut(MouseButton, ScreenPoint, LocalPoint)>>,
    pub on_mouse_up: Option<Box<dyn FnMut(MouseButton, ScreenPoint, LocalPoint)>>,
    pub on_click: Option<Box<dyn FnMut(MouseButton, ScreenPoint, LocalPoint)>>,
}
...
impl EventHandlers {
    ...
    where
        F: FnMut(MouseButton, ScreenPoint, LocalPoint) + 'static,
    {
